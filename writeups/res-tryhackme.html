# res-tryhackme-writup
 ...
 mais je vois pas grand chose d'intéressant sur le site


 je vais commencer par me connecter puis essayer d'avoir la version:
  en cherchant j'ai trouver la commande "info" pour avoir les informations sur le gestionnaire
   ...
   puis maintenant je dois trouver le moyen comment avoir un shell <br>
  ...
  puis je vois que j'ai bien réussi !
   ...
   maintenant que nous avons un shell il faut monter de privilèges jusqu'à root <br>
